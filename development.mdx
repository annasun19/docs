...
All API requests should be made to `https://getnowadays.com/api/northstar`. The API accepts JSON-encoded request bodies and returns JSON-encoded responses.
...
<AccordionGroup>
  ...
  <Accordion title="Pagination">
    ...
    ```bash
    curl https://getnowadays.com/api/northstar/events/{eventId}/venues?limit=10
    ```
  </Accordion>
</AccordionGroup>
