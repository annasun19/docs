...
All API requests should be made to `https://meetings-conventions-nowadays.com/api/northstar`. The API accepts JSON-encoded request bodies and returns JSON-encoded responses.
...
```bash
curl -X POST https://meetings-conventions-nowadays.com/api/northstar/events \
...
<AccordionGroup>
  ...
  <Accordion title="Pagination">
    ...
    ```bash
    curl https://meetings-conventions-nowadays.com/api/northstar/events/{eventId}/venues?limit=10
    ```
  </Accordion>
</AccordionGroup>
