...
<AccordionGroup>
  <Accordion icon="key" title="Get your API key">
    ...
    founders@getnowadays.com to get your API credentials. Keep your API key
...
<Accordion icon="building" title="Get venue options">
  ...
  ```bash
  curl https://meetings-conventions-nowadays.com/api/northstar/events/{eventId}/venues \
    -H "Authorization: Bearer YOUR_API_KEY"
  ```
</Accordion>
</AccordionGroup>
